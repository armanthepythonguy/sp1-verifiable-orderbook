...
use clap::Parser;
use fibonacci_lib::{match_order, Order, OrderType, State, Trade};
...
fn main() {
    ...
    transactions.push(Order{id:"123".to_string(), order_type:OrderType::Bid, price: 1.05, quantity: 1000});
    transactions.push(Order{id:"123".to_string(), order_type:OrderType::Ask, price: 1.05, quantity: 1000});
